...
class BankStatementTransactionsModel(Base):
    __tablename__ = "bank_statements_transactions"
    ...
    bankStatement = relationship("BankStatement", back_populates="bankStatementTransactions")
